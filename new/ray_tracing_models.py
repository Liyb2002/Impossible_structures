...
class Camera:
    ...
    @ti.kernel
    def reset(self):
        self.lookfrom[None] = [0.4, 0.5, 2.0]
    ...
    def get_ray(self, u, v):
        ...
        print("self.cam_lower_left_corner[None]", self.cam_lower_left_corner[None])
        print("u", u)
        print("self.cam_horizontal[None]", u * self.cam_horizontal[None])
        print("self.cam_vertical[None]", v * self.cam_vertical[None])
        print("self.cam_origin[None]", self.cam_origin[None])
