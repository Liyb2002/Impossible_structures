...
CALIBRATION_COEF = 0.782063919333252215701427386350813024
...
class Scene:
    ...
    def get_impossible_intersection(self):
        ...
        ray = self.camera.get_ray(u, v) / CALIBRATION_COEF
    ...
    def get_possible_intersects(self, k):
        return np.array(
            [
                self.possible_intersects[k][0],
                self.possible_intersects[k][1],
                self.possible_intersects[k][2],
            ]
        )
